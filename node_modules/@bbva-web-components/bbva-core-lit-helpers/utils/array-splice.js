...
function sharedSuffix(current, old, searchLength) {
  let index1 = current.length - 1;
  let index2 = old.length - 1;
  let count = 0;
 ...
 */
function calcSplices(current, currentS, currentE, old, oldS, oldE) {
  let prefixCount = 0;
  let suffixCount = 0;
  let splice;
  let currentStart = currentS;
  let currentEnd = currentE;
  let oldStart = oldS;
  let oldEnd = oldE;
