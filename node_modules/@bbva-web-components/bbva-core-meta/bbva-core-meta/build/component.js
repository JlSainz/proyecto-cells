(function (global, factory) {
  ...
  */
  ...
  if (window.ShadyCSS && window.ShadyCSS.CustomStyleInterface) {
    ...
    console.warn('CustomStyleInterface not detected. Be sure to add ShadyCSS CustomStyleInterface to your app!');
  }
  /**
...
`);
  ...
  */
  ...
  function resolveUrl$1(url, baseURIparam) {
    let baseURI = baseURIparam;
  ...
  */
  ...
  function setModule$1(id, module) {
    // store id separate from lowercased id so that
    // in all cases mixedCase id will stored distinctly
    // and lowercase version is a fallback
    modules$1[id] = module;
    lcModules$1[id.toLowerCase()] = module;
  }
  /**
   * Retrieves a bbva-core-dom-module from the global registry by id.
   *
  ...
  function findModule$1(id) {
    return modules$1[id] || lcModules$1[id.toLowerCase()];
  }
  /**
   * The `bbva-core-dom-module` element registers the dom it contains to the name given
   * by the module's id attribute. It provides a unified database of dom
  ...
  class BbvaCoreDomModule$1 extends HTMLElement {
    static get observedAttributes() {
      return ['id'];
    }
    /**
    ...
    get assetpath() {
      ...
      if (!this.__assetpath) {
        const owner = this.ownerDocument;
        const url = resolveUrl$1(this.getAttribute('assetpath') || '', owner.baseURI);
        this.__assetpath = pathFromUrl$1(url);
      }
  ...
  BbvaCoreDomModule$1.prototype.modules = modules$1;
  BbvaCoreDomModule$1.prototype.modulesStyles = {};

  if (!customElements.get('bbva-core-dom-module')) {
    customElements.define('bbva-core-dom-module', BbvaCoreDomModule$1);
  }
  ...
  */
  ...
  class BbvaCoreCustomStyle$1 extends HTMLElement {
    constructor() {
      super();
      this._style = null;
  ...
  if (!customElements.get('bbva-core-custom-style')) {
    customElements.define('bbva-core-custom-style', BbvaCoreCustomStyle$1);
  }
  ...
  const setDocumentCustomStyles$1 = styles => {
    const customStyles = document.createElement('template');
    customStyles.setAttribute('style', 'display: none;');
    customStyles.innerHTML = `
  <bbva-core-custom-style>
